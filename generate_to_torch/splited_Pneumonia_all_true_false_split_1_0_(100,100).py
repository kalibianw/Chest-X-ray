from utils import DataModule, NeuralNetwork100, TrainModule, TestModule
...
BATCH_SIZE = 32
EPOCHS = 1000
MODEL_PATH = "splited_Pneumonia_all_true_false_split_1_0_(100, 100)_combined.pt"
...
nploader = np.load("splited_Pneumonia_all_true_false_split_1_0_(100, 100).npz")
for key in nploader:
    print(key)
...
neural_network = NeuralNetwork100()
model = neural_network.to(DEVICE)
summary(model, input_size=(32, 1, 100, 100))

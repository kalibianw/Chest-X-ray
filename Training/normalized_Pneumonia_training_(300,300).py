...
nploader = np.load("../APP/splited_Pneumonia_all_true_false_split_1_(300, 375).npz")
...
tm = TrainModule(ckpt_path="C:/Users/admin/Documents/AI/ckpt/Coronahack-Chest-XRay/normalized_splited_Pneumonia_(300, 375)_TF.ckpt",
                 model_save_name="C:/Users/admin/Documents/AI/model/coronahack/normalized_splited_Pneumonia_(300, 375)_TF",
                 input_shape=np.shape(train_x_data)[1:],
                 result_file_name="normalized_splited_Pneumonia_(300, 375)_training_result_TF"
                 )

...
tm = TrainModule(
    ckpt_path="C:/Users/admin/Documents/AI/ckpt/Coronahack-Chest-XRay/splited_Pneumonia_(200, 250)_TF.ckpt",
    model_save_name="C:/Users/admin/Documents/AI/model/coronahack/splited_Pneumonia_(200, 250)_TF",
    input_shape=np.shape(train_x_data)[1:],
    result_file_name="splited_Pneumonia_(200, 250)_training_result_TF"
)
